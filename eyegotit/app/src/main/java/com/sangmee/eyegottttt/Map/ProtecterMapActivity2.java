...
public class ProtecterMapActivity2 extends AppCompatActivity implements OnMapReadyCallback,NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* CameraPosition cameraPosition = new CameraPosition(new LatLng(latitude_L, longitude_L), 17);
        ...
        //removeData();
            ...
            /*SharedPreferences.OnSharedPreferenceChangeListener mapA=new SharedPreferences.OnSharedPreferenceChangeListener() {
            @Override
            public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
                String lati_L = sharedPreferences.getString("latitude", "");
                String longi_L = sharedPreferences.getString("longitude", "");
    ...
    public void removeData() {
        ...
        String lati_t = tmsg.getString("latitude", "");
        String longi_t = tmsg.getString("longitude", "");
        if(lati_t != null && longi_t !=null) {
            editor.remove("lati_t");
            editor.remove("longi_t");
            editor.commit();
        }
    }
